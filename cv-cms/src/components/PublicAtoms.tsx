...
export const CodeSnippet = ({ code, language }: { code: string; language: string }) => (
  <div className="relative group">
    ...
    <pre className="p-8 rounded-[32px] bg-[#010610] border border-white/5 overflow-x-auto scrollbar-hide text-sm font-mono text-white/80 leading-relaxed">
      <code>{code}</code>
    </pre>
    <div className="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-[#010610] to-transparent pointer-events-none opacity-50" />
  </div>
);
